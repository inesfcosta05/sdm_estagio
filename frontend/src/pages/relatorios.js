...
const actionBtn = { background: '#f6f7f7', border: '1px solid #c3c4c7', borderRadius: 3, padding: '5px 12px', fontSize: '0.88rem', cursor: 'pointer', color: '#1d2327', whiteSpace: 'nowrap', flexShrink: 0 };
...
const clearBtn = { background: 'none', border: 'none', color: 'var(--theme-topbar-start, #2271b1)', fontSize: '0.88rem', cursor: 'pointer', padding: '5px 0', whiteSpace: 'nowrap', flexShrink: 0 };
