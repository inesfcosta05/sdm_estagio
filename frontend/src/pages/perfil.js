...
const COLOR_SCHEMES = [
  { id: 'default', label: 'Por omissao', colors: ['#1d2327', '#2c3338', '#2271b1', '#72aee6'] },
  ...
  { id: 'coffee', label: 'Cafe', colors: ['#46403c', '#59524c', '#c7a589', '#9ea476'] },
...
export default function Perfil({ user, language = 'default', onLanguageChange, colorScheme = 'ocean', onColorSchemeChange, onProfileUpdate, customSchemes = [], onCustomSchemesChange }) {
  ...
  const t = {
    pt: {
      ...
      disableEditor: 'Nao utilizar o editor visual ao escrever',
      ...
      emailHelp: 'Se alterar isto, sera enviado um email de confirmação para o seu novo endereço.',
      site: 'Site',
      about: 'Sobre si',
      ...
      appPasswordsHelp: 'As senhas de aplicação permitem a autenticação através de sistemas nao interativos, como XML-RPC ou a REST API, sem ter de fornecer a sua senha.',
